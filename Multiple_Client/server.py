...
# Establish connections with multiple  client and saving to a list (socket must be listening)
    ...
    while True:
        try:
            ...
            if len(str.encode(cmd)) > 0:
                ...
                client_response = str(c.recv(20480), "utf-8")
